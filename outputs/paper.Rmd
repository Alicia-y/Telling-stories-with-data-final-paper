...
In Model \@ref(eq:1):
  ...
  - $Y_{ij}$ is the difference between the highest and lowest decile of average after-tax income in $i^{th}$ year and province $j$.
...
P-value is an important value used to determine whether a predictor variable has significant impact on the responce variable. It measures ...

By examining the P-values of all the predictor variables of the model, we found that they are all less than 0.05. 

Table \@ref(tab:table1) shows the coefficients of the predictor variables of Model \@ref(eq:1). The baseline of the model is year 0 and Alberta province, 
...
(4)http://www.sthda.com/english/articles/39-regression-model-diagnostics/161-linear-regression-assumptions-and-diagnostics-in-r-essentials/

(5)https://stats.stackexchange.com/questions/577/is-there-any-reason-to-prefer-the-aic-or-bic-over-the-other
